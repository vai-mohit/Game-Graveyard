...
public class Address extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(40, 150, 160, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AddressChange.jpg"))); // NOI18N
...
this.dispose(); // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            Statement y;
            y=x.createStatement();
            String q="Update Account SET Address = '"+c+"' where Username = '"+Game.username+"';" ;
