 ...
 */import java.sql.*;
import javax.swing.*;
public class CreditCardName extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setBounds(70, 70, 170, 30);

        jLabel6.setFont(new java.awt.Font("YouMurderer BB", 2, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("card Name");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(320, 70, 190, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CreditCardNameChange.jpg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      String c;
        ...
        try
        {
            ...
            Statement y;
            y=x.createStatement();
            String q="Update Account SET CreditCardName = '"+c+"' where Username = '"+Game.username+"';" ;
