...
import java.sql.*;
        import javax.swing.*;
public class CreditCardNumber extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(60, 110, 140, 30);

        jTextField1.setEnabled(false);
        getContentPane().add(jTextField1);
        jTextField1.setBounds(240, 120, 290, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CreditCardNumberChange.jpg"))); // NOI18N
...
this.dispose(); // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            Statement y;
            y=x.createStatement();
            String q="Update Account SET CreditCardNumber = '"+c+"' where Username = '"+Game.username+"';" ;
