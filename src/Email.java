...
public class Email extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(330, 120, 200, 30);
        ...
        jButton2.setBounds(350, 220, 100, 23);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/EmailChange.jpg"))); // NOI18N
...
this.dispose(); // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            Statement y;
            y=x.createStatement();
            String q="Update Account SET Email = '"+c+"' where Username = '"+Game.username+"';" ;
