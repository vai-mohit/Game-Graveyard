...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(10, 0, 570, 320);
...
Game.username=jTextField1.getText();
Game.password=String.valueOf(jPasswordField1.getPassword());
SignUpCredit x=new SignUpCredit();
        x.setVisible(true);
        this.dispose();
